        ...
        <a href="{{ url('category/'.$categories->slug.'/'.$product->slug) }}"
          ...
          <div class="d-flex flex-wrap gap-5 ms-2">
            <div class="card card-product" style="width: 242px">
              ...
              <img
              src="{{asset('frontend/img/default_product.png')  }}">
              @else
              <img
              ...
              <div class="card-body pt-0">
                <div class="container">
                  ...
                  <div class="row">
                    <div class="col">
                      <p class="product-name" style="height: 40px;line-height: 1.2;margin-bottom: 4px;">
                        {{ $product->name }}</p>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    @php
                      if(Auth::check()){
                      $wishlistCheck = App\Models\Wishlists::where('product_id', $product->id)->where('user_id', Auth::user()->id)->exists();
                      }
                    @endphp
                      ...
                      <div class="row">
                        <div class="col-3 pe-0">
                          @if(Auth::check())
                            ...
                            @else
                              <img class="keranjang-hov" wire:click.prevent='addToWishlist({{ $product->id }})'
                        ...
                        <div class="col-9 pe-3 d-flex my-auto">
                          <button wire:click.prevent='addToCart({{ $product->id }})' class="btn btn-cart-produk">+
                            Keranjang</button>
                        </div>
                      </div>
                    </div>
